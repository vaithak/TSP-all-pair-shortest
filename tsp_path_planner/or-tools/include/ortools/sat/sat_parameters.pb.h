...
#define PROTOBUF_INTERNAL_EXPORT_ortools_2fsat_2fsat_5fparameters_2eproto OR_PROTO_DLL
...
struct OR_PROTO_DLL TableStruct_ortools_2fsat_2fsat_5fparameters_2eproto {
...
OR_PROTO_DLL extern SatParametersDefaultTypeInternal _SatParameters_default_instance_;
}  // namespace sat
}  // namespace operations_research
namespace google {
namespace protobuf {
...
OR_PROTO_DLL bool SatParameters_VariableOrder_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_VariableOrder_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_Polarity_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_Polarity_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_ConflictMinimizationAlgorithm_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_ConflictMinimizationAlgorithm_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_BinaryMinizationAlgorithm_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_BinaryMinizationAlgorithm_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_ClauseProtection_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_ClauseProtection_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_ClauseOrdering_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_ClauseOrdering_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_RestartAlgorithm_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_RestartAlgorithm_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_MaxSatAssumptionOrder_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_MaxSatAssumptionOrder_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_MaxSatStratificationAlgorithm_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_MaxSatStratificationAlgorithm_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_SearchBranching_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_SearchBranching_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_SharedTreeSplitStrategy_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_SharedTreeSplitStrategy_internal_data_[];
...
OR_PROTO_DLL bool SatParameters_FPRoundingMethod_IsValid(int value);
OR_PROTO_DLL extern const uint32_t SatParameters_FPRoundingMethod_internal_data_[];
...
class OR_PROTO_DLL SatParameters final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.sat.SatParameters) */ {
 ...
 public:
  ...
  enum : int {
    ...
    kPolarityExploitLsHintsFieldNumber = 309,
    ...
    kDebugCrashIfPresolveBreaksHintFieldNumber = 306,
    ...
    kUseSymmetryInLpFieldNumber = 301,
    kKeepSymmetryInPresolveFieldNumber = 303,
    ...
    kInprocessingMinimizationUseAllOrderingsFieldNumber = 298,
    ...
    kUseTryEdgeReasoningInNoOverlap2DFieldNumber = 299,
    kUseAllDifferentForCircuitFieldNumber = 311,
    ...
    kRoutingCutSubsetSizeForBinaryRelationBoundFieldNumber = 312,
    kRoutingCutSubsetSizeForTightBinaryRelationBoundFieldNumber = 313,
    kMaximumRegionsToSplitInDisconnectedNoOverlap2DFieldNumber = 315,
    ...
    kMinimizeSharedClausesFieldNumber = 300,
    ...
    kInprocessingMinimizationUseConflictAnalysisFieldNumber = 297,
    ...
    kRemoveFixedVariablesEarlyFieldNumber = 310,
    ...
    kSharedTreeWorkerEnablePhaseSharingFieldNumber = 304,
    ...
    kLbRelaxNumWorkersThresholdFieldNumber = 296,
    kSharedTreeBalanceToleranceFieldNumber = 305,
    kSymmetryDetectionDeterministicTimeLimitFieldNumber = 302,
    kLnsInitialDifficultyFieldNumber = 307,
    kLnsInitialDeterministicLimitFieldNumber = 308,
    kRoutingCutDpEffortFieldNumber = 314,
  };
  ...
  private:
  bool _internal_polarity_exploit_ls_hints() const;
  void _internal_set_polarity_exploit_ls_hints(bool value);
  ...
  private:
  bool _internal_debug_crash_if_presolve_breaks_hint() const;
  void _internal_set_debug_crash_if_presolve_breaks_hint(bool value);
  ...
  private:
  bool _internal_use_symmetry_in_lp() const;
  void _internal_set_use_symmetry_in_lp(bool value);
  ...
  private:
  bool _internal_keep_symmetry_in_presolve() const;
  void _internal_set_keep_symmetry_in_presolve(bool value);
  ...
  private:
  bool _internal_inprocessing_minimization_use_all_orderings() const;
  void _internal_set_inprocessing_minimization_use_all_orderings(bool value);
  ...
  private:
  bool _internal_use_try_edge_reasoning_in_no_overlap_2d() const;
  void _internal_set_use_try_edge_reasoning_in_no_overlap_2d(bool value);
  ...
  private:
  bool _internal_use_all_different_for_circuit() const;
  void _internal_set_use_all_different_for_circuit(bool value);
  ...
  private:
  ::int32_t _internal_routing_cut_subset_size_for_binary_relation_bound() const;
  void _internal_set_routing_cut_subset_size_for_binary_relation_bound(::int32_t value);
  ...
  private:
  ::int32_t _internal_routing_cut_subset_size_for_tight_binary_relation_bound() const;
  void _internal_set_routing_cut_subset_size_for_tight_binary_relation_bound(::int32_t value);
  ...
  private:
  ::int32_t _internal_maximum_regions_to_split_in_disconnected_no_overlap_2d() const;
  void _internal_set_maximum_regions_to_split_in_disconnected_no_overlap_2d(::int32_t value);
  ...
  private:
  bool _internal_minimize_shared_clauses() const;
  void _internal_set_minimize_shared_clauses(bool value);
  ...
  private:
  bool _internal_inprocessing_minimization_use_conflict_analysis() const;
  void _internal_set_inprocessing_minimization_use_conflict_analysis(bool value);
  ...
  private:
  bool _internal_remove_fixed_variables_early() const;
  void _internal_set_remove_fixed_variables_early(bool value);
  ...
  private:
  bool _internal_shared_tree_worker_enable_phase_sharing() const;
  void _internal_set_shared_tree_worker_enable_phase_sharing(bool value);
  ...
  private:
  ::int32_t _internal_lb_relax_num_workers_threshold() const;
  void _internal_set_lb_relax_num_workers_threshold(::int32_t value);
  ...
  private:
  ::int32_t _internal_shared_tree_balance_tolerance() const;
  void _internal_set_shared_tree_balance_tolerance(::int32_t value);
  ...
  private:
  double _internal_symmetry_detection_deterministic_time_limit() const;
  void _internal_set_symmetry_detection_deterministic_time_limit(double value);
  ...
  private:
  double _internal_lns_initial_difficulty() const;
  void _internal_set_lns_initial_difficulty(double value);
  ...
  private:
  double _internal_lns_initial_deterministic_limit() const;
  void _internal_set_lns_initial_deterministic_limit(double value);
  ...
  private:
  double _internal_routing_cut_dp_effort() const;
  void _internal_set_routing_cut_dp_effort(double value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    bool polarity_exploit_ls_hints_;
    ...
    bool debug_crash_if_presolve_breaks_hint_;
    ...
    bool use_symmetry_in_lp_;
    bool keep_symmetry_in_presolve_;
    ...
    bool inprocessing_minimization_use_all_orderings_;
    ...
    bool use_try_edge_reasoning_in_no_overlap_2d_;
    bool use_all_different_for_circuit_;
    bool repair_hint_;
    ::int32_t max_lin_max_size_for_expansion_;
    ::int32_t max_num_deterministic_batches_;
    ::int32_t num_full_subsolvers_;
    ::int32_t routing_cut_subset_size_for_binary_relation_bound_;
    ::int32_t routing_cut_subset_size_for_tight_binary_relation_bound_;
    ::int32_t maximum_regions_to_split_in_disconnected_no_overlap_2d_;
    ...
    bool inprocessing_minimization_use_conflict_analysis_;
    ...
    bool remove_fixed_variables_early_;
    ...
    bool shared_tree_worker_enable_phase_sharing_;
    ...
    ::int32_t lb_relax_num_workers_threshold_;
    ::int32_t shared_tree_balance_tolerance_;
    double symmetry_detection_deterministic_time_limit_;
    double lns_initial_difficulty_;
    double lns_initial_deterministic_limit_;
    double routing_cut_dp_effort_;
...
// optional bool polarity_exploit_ls_hints = 309 [default = false];
inline bool SatParameters::has_polarity_exploit_ls_hints() const {
  bool value = (_impl_._has_bits_[0] & 0x00100000u) != 0;
  return value;
}
inline void SatParameters::clear_polarity_exploit_ls_hints() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.polarity_exploit_ls_hints_ = false;
  _impl_._has_bits_[0] &= ~0x00100000u;
}
inline bool SatParameters::polarity_exploit_ls_hints() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.polarity_exploit_ls_hints)
  return _internal_polarity_exploit_ls_hints();
}
inline void SatParameters::set_polarity_exploit_ls_hints(bool value) {
  _internal_set_polarity_exploit_ls_hints(value);
  _impl_._has_bits_[0] |= 0x00100000u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.polarity_exploit_ls_hints)
}
inline bool SatParameters::_internal_polarity_exploit_ls_hints() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.polarity_exploit_ls_hints_;
}
inline void SatParameters::_internal_set_polarity_exploit_ls_hints(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.polarity_exploit_ls_hints_ = value;
}
...
// optional bool remove_fixed_variables_early = 310 [default = true];
inline bool SatParameters::has_remove_fixed_variables_early() const {
  bool value = (_impl_._has_bits_[6] & 0x04000000u) != 0;
  return value;
}
inline void SatParameters::clear_remove_fixed_variables_early() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.remove_fixed_variables_early_ = true;
  _impl_._has_bits_[6] &= ~0x04000000u;
}
inline bool SatParameters::remove_fixed_variables_early() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.remove_fixed_variables_early)
  return _internal_remove_fixed_variables_early();
}
inline void SatParameters::set_remove_fixed_variables_early(bool value) {
  _internal_set_remove_fixed_variables_early(value);
  _impl_._has_bits_[6] |= 0x04000000u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.remove_fixed_variables_early)
}
inline bool SatParameters::_internal_remove_fixed_variables_early() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.remove_fixed_variables_early_;
}
inline void SatParameters::_internal_set_remove_fixed_variables_early(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.remove_fixed_variables_early_ = value;
}
...
// optional bool inprocessing_minimization_use_conflict_analysis = 297 [default = true];
inline bool SatParameters::has_inprocessing_minimization_use_conflict_analysis() const {
  bool value = (_impl_._has_bits_[6] & 0x00020000u) != 0;
  return value;
}
inline void SatParameters::clear_inprocessing_minimization_use_conflict_analysis() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.inprocessing_minimization_use_conflict_analysis_ = true;
  _impl_._has_bits_[6] &= ~0x00020000u;
}
inline bool SatParameters::inprocessing_minimization_use_conflict_analysis() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.inprocessing_minimization_use_conflict_analysis)
  return _internal_inprocessing_minimization_use_conflict_analysis();
}
inline void SatParameters::set_inprocessing_minimization_use_conflict_analysis(bool value) {
  _internal_set_inprocessing_minimization_use_conflict_analysis(value);
  _impl_._has_bits_[6] |= 0x00020000u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.inprocessing_minimization_use_conflict_analysis)
}
inline bool SatParameters::_internal_inprocessing_minimization_use_conflict_analysis() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.inprocessing_minimization_use_conflict_analysis_;
}
inline void SatParameters::_internal_set_inprocessing_minimization_use_conflict_analysis(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.inprocessing_minimization_use_conflict_analysis_ = value;
}

// optional bool inprocessing_minimization_use_all_orderings = 298 [default = false];
inline bool SatParameters::has_inprocessing_minimization_use_all_orderings() const {
  bool value = (_impl_._has_bits_[2] & 0x00080000u) != 0;
  return value;
}
inline void SatParameters::clear_inprocessing_minimization_use_all_orderings() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.inprocessing_minimization_use_all_orderings_ = false;
  _impl_._has_bits_[2] &= ~0x00080000u;
}
inline bool SatParameters::inprocessing_minimization_use_all_orderings() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.inprocessing_minimization_use_all_orderings)
  return _internal_inprocessing_minimization_use_all_orderings();
}
inline void SatParameters::set_inprocessing_minimization_use_all_orderings(bool value) {
  _internal_set_inprocessing_minimization_use_all_orderings(value);
  _impl_._has_bits_[2] |= 0x00080000u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.inprocessing_minimization_use_all_orderings)
}
inline bool SatParameters::_internal_inprocessing_minimization_use_all_orderings() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.inprocessing_minimization_use_all_orderings_;
}
inline void SatParameters::_internal_set_inprocessing_minimization_use_all_orderings(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.inprocessing_minimization_use_all_orderings_ = value;
}
...
// optional bool minimize_shared_clauses = 300 [default = true];
inline bool SatParameters::has_minimize_shared_clauses() const {
  bool value = (_impl_._has_bits_[5] & 0x08000000u) != 0;
  return value;
}
inline void SatParameters::clear_minimize_shared_clauses() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.minimize_shared_clauses_ = true;
  _impl_._has_bits_[5] &= ~0x08000000u;
}
inline bool SatParameters::minimize_shared_clauses() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.minimize_shared_clauses)
  return _internal_minimize_shared_clauses();
}
inline void SatParameters::set_minimize_shared_clauses(bool value) {
  _internal_set_minimize_shared_clauses(value);
  _impl_._has_bits_[5] |= 0x08000000u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.minimize_shared_clauses)
}
inline bool SatParameters::_internal_minimize_shared_clauses() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.minimize_shared_clauses_;
}
inline void SatParameters::_internal_set_minimize_shared_clauses(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.minimize_shared_clauses_ = value;
}
...
// optional bool debug_crash_if_presolve_breaks_hint = 306 [default = false];
inline bool SatParameters::has_debug_crash_if_presolve_breaks_hint() const {
  bool value = (_impl_._has_bits_[2] & 0x00000100u) != 0;
  return value;
}
inline void SatParameters::clear_debug_crash_if_presolve_breaks_hint() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.debug_crash_if_presolve_breaks_hint_ = false;
  _impl_._has_bits_[2] &= ~0x00000100u;
}
inline bool SatParameters::debug_crash_if_presolve_breaks_hint() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.debug_crash_if_presolve_breaks_hint)
  return _internal_debug_crash_if_presolve_breaks_hint();
}
inline void SatParameters::set_debug_crash_if_presolve_breaks_hint(bool value) {
  _internal_set_debug_crash_if_presolve_breaks_hint(value);
  _impl_._has_bits_[2] |= 0x00000100u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.debug_crash_if_presolve_breaks_hint)
}
inline bool SatParameters::_internal_debug_crash_if_presolve_breaks_hint() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.debug_crash_if_presolve_breaks_hint_;
}
inline void SatParameters::_internal_set_debug_crash_if_presolve_breaks_hint(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.debug_crash_if_presolve_breaks_hint_ = value;
}
...
// optional bool use_try_edge_reasoning_in_no_overlap_2d = 299 [default = false];
inline bool SatParameters::has_use_try_edge_reasoning_in_no_overlap_2d() const {
  bool value = (_impl_._has_bits_[2] & 0x80000000u) != 0;
  return value;
}
inline void SatParameters::clear_use_try_edge_reasoning_in_no_overlap_2d() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_try_edge_reasoning_in_no_overlap_2d_ = false;
  _impl_._has_bits_[2] &= ~0x80000000u;
}
inline bool SatParameters::use_try_edge_reasoning_in_no_overlap_2d() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.use_try_edge_reasoning_in_no_overlap_2d)
  return _internal_use_try_edge_reasoning_in_no_overlap_2d();
}
inline void SatParameters::set_use_try_edge_reasoning_in_no_overlap_2d(bool value) {
  _internal_set_use_try_edge_reasoning_in_no_overlap_2d(value);
  _impl_._has_bits_[2] |= 0x80000000u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.use_try_edge_reasoning_in_no_overlap_2d)
}
inline bool SatParameters::_internal_use_try_edge_reasoning_in_no_overlap_2d() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.use_try_edge_reasoning_in_no_overlap_2d_;
}
inline void SatParameters::_internal_set_use_try_edge_reasoning_in_no_overlap_2d(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_try_edge_reasoning_in_no_overlap_2d_ = value;
}
...
// optional int32 maximum_regions_to_split_in_disconnected_no_overlap_2d = 315 [default = 0];
inline bool SatParameters::has_maximum_regions_to_split_in_disconnected_no_overlap_2d() const {
  bool value = (_impl_._has_bits_[3] & 0x00000080u) != 0;
  return value;
}
inline void SatParameters::clear_maximum_regions_to_split_in_disconnected_no_overlap_2d() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.maximum_regions_to_split_in_disconnected_no_overlap_2d_ = 0;
  _impl_._has_bits_[3] &= ~0x00000080u;
}
inline ::int32_t SatParameters::maximum_regions_to_split_in_disconnected_no_overlap_2d() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.maximum_regions_to_split_in_disconnected_no_overlap_2d)
  return _internal_maximum_regions_to_split_in_disconnected_no_overlap_2d();
}
inline void SatParameters::set_maximum_regions_to_split_in_disconnected_no_overlap_2d(::int32_t value) {
  _internal_set_maximum_regions_to_split_in_disconnected_no_overlap_2d(value);
  _impl_._has_bits_[3] |= 0x00000080u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.maximum_regions_to_split_in_disconnected_no_overlap_2d)
}
inline ::int32_t SatParameters::_internal_maximum_regions_to_split_in_disconnected_no_overlap_2d() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.maximum_regions_to_split_in_disconnected_no_overlap_2d_;
}
inline void SatParameters::_internal_set_maximum_regions_to_split_in_disconnected_no_overlap_2d(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.maximum_regions_to_split_in_disconnected_no_overlap_2d_ = value;
}
...
// optional bool use_all_different_for_circuit = 311 [default = false];
inline bool SatParameters::has_use_all_different_for_circuit() const {
  bool value = (_impl_._has_bits_[3] & 0x00000001u) != 0;
  return value;
}
inline void SatParameters::clear_use_all_different_for_circuit() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_all_different_for_circuit_ = false;
  _impl_._has_bits_[3] &= ~0x00000001u;
}
inline bool SatParameters::use_all_different_for_circuit() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.use_all_different_for_circuit)
  return _internal_use_all_different_for_circuit();
}
inline void SatParameters::set_use_all_different_for_circuit(bool value) {
  _internal_set_use_all_different_for_circuit(value);
  _impl_._has_bits_[3] |= 0x00000001u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.use_all_different_for_circuit)
}
inline bool SatParameters::_internal_use_all_different_for_circuit() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.use_all_different_for_circuit_;
}
inline void SatParameters::_internal_set_use_all_different_for_circuit(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_all_different_for_circuit_ = value;
}

// optional int32 routing_cut_subset_size_for_binary_relation_bound = 312 [default = 0];
inline bool SatParameters::has_routing_cut_subset_size_for_binary_relation_bound() const {
  bool value = (_impl_._has_bits_[3] & 0x00000020u) != 0;
  return value;
}
inline void SatParameters::clear_routing_cut_subset_size_for_binary_relation_bound() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.routing_cut_subset_size_for_binary_relation_bound_ = 0;
  _impl_._has_bits_[3] &= ~0x00000020u;
}
inline ::int32_t SatParameters::routing_cut_subset_size_for_binary_relation_bound() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.routing_cut_subset_size_for_binary_relation_bound)
  return _internal_routing_cut_subset_size_for_binary_relation_bound();
}
inline void SatParameters::set_routing_cut_subset_size_for_binary_relation_bound(::int32_t value) {
  _internal_set_routing_cut_subset_size_for_binary_relation_bound(value);
  _impl_._has_bits_[3] |= 0x00000020u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.routing_cut_subset_size_for_binary_relation_bound)
}
inline ::int32_t SatParameters::_internal_routing_cut_subset_size_for_binary_relation_bound() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.routing_cut_subset_size_for_binary_relation_bound_;
}
inline void SatParameters::_internal_set_routing_cut_subset_size_for_binary_relation_bound(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.routing_cut_subset_size_for_binary_relation_bound_ = value;
}

// optional int32 routing_cut_subset_size_for_tight_binary_relation_bound = 313 [default = 0];
inline bool SatParameters::has_routing_cut_subset_size_for_tight_binary_relation_bound() const {
  bool value = (_impl_._has_bits_[3] & 0x00000040u) != 0;
  return value;
}
inline void SatParameters::clear_routing_cut_subset_size_for_tight_binary_relation_bound() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.routing_cut_subset_size_for_tight_binary_relation_bound_ = 0;
  _impl_._has_bits_[3] &= ~0x00000040u;
}
inline ::int32_t SatParameters::routing_cut_subset_size_for_tight_binary_relation_bound() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.routing_cut_subset_size_for_tight_binary_relation_bound)
  return _internal_routing_cut_subset_size_for_tight_binary_relation_bound();
}
inline void SatParameters::set_routing_cut_subset_size_for_tight_binary_relation_bound(::int32_t value) {
  _internal_set_routing_cut_subset_size_for_tight_binary_relation_bound(value);
  _impl_._has_bits_[3] |= 0x00000040u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.routing_cut_subset_size_for_tight_binary_relation_bound)
}
inline ::int32_t SatParameters::_internal_routing_cut_subset_size_for_tight_binary_relation_bound() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.routing_cut_subset_size_for_tight_binary_relation_bound_;
}
inline void SatParameters::_internal_set_routing_cut_subset_size_for_tight_binary_relation_bound(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.routing_cut_subset_size_for_tight_binary_relation_bound_ = value;
}

// optional double routing_cut_dp_effort = 314 [default = 10000000];
inline bool SatParameters::has_routing_cut_dp_effort() const {
  bool value = (_impl_._has_bits_[8] & 0x00000010u) != 0;
  return value;
}
inline void SatParameters::clear_routing_cut_dp_effort() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.routing_cut_dp_effort_ = 10000000;
  _impl_._has_bits_[8] &= ~0x00000010u;
}
inline double SatParameters::routing_cut_dp_effort() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.routing_cut_dp_effort)
  return _internal_routing_cut_dp_effort();
}
inline void SatParameters::set_routing_cut_dp_effort(double value) {
  _internal_set_routing_cut_dp_effort(value);
  _impl_._has_bits_[8] |= 0x00000010u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.routing_cut_dp_effort)
}
inline double SatParameters::_internal_routing_cut_dp_effort() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.routing_cut_dp_effort_;
}
inline void SatParameters::_internal_set_routing_cut_dp_effort(double value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.routing_cut_dp_effort_ = value;
}
...
// optional bool shared_tree_worker_enable_phase_sharing = 304 [default = true];
inline bool SatParameters::has_shared_tree_worker_enable_phase_sharing() const {
  bool value = (_impl_._has_bits_[7] & 0x00000040u) != 0;
  return value;
}
inline void SatParameters::clear_shared_tree_worker_enable_phase_sharing() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.shared_tree_worker_enable_phase_sharing_ = true;
  _impl_._has_bits_[7] &= ~0x00000040u;
}
inline bool SatParameters::shared_tree_worker_enable_phase_sharing() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.shared_tree_worker_enable_phase_sharing)
  return _internal_shared_tree_worker_enable_phase_sharing();
}
inline void SatParameters::set_shared_tree_worker_enable_phase_sharing(bool value) {
  _internal_set_shared_tree_worker_enable_phase_sharing(value);
  _impl_._has_bits_[7] |= 0x00000040u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.shared_tree_worker_enable_phase_sharing)
}
inline bool SatParameters::_internal_shared_tree_worker_enable_phase_sharing() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.shared_tree_worker_enable_phase_sharing_;
}
inline void SatParameters::_internal_set_shared_tree_worker_enable_phase_sharing(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.shared_tree_worker_enable_phase_sharing_ = value;
}
...
// optional int32 shared_tree_balance_tolerance = 305 [default = 1];
inline bool SatParameters::has_shared_tree_balance_tolerance() const {
  bool value = (_impl_._has_bits_[8] & 0x00000001u) != 0;
  return value;
}
inline void SatParameters::clear_shared_tree_balance_tolerance() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.shared_tree_balance_tolerance_ = 1;
  _impl_._has_bits_[8] &= ~0x00000001u;
}
inline ::int32_t SatParameters::shared_tree_balance_tolerance() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.shared_tree_balance_tolerance)
  return _internal_shared_tree_balance_tolerance();
}
inline void SatParameters::set_shared_tree_balance_tolerance(::int32_t value) {
  _internal_set_shared_tree_balance_tolerance(value);
  _impl_._has_bits_[8] |= 0x00000001u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.shared_tree_balance_tolerance)
}
inline ::int32_t SatParameters::_internal_shared_tree_balance_tolerance() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.shared_tree_balance_tolerance_;
}
inline void SatParameters::_internal_set_shared_tree_balance_tolerance(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.shared_tree_balance_tolerance_ = value;
}
...
// optional double lns_initial_difficulty = 307 [default = 0.5];
inline bool SatParameters::has_lns_initial_difficulty() const {
  bool value = (_impl_._has_bits_[8] & 0x00000004u) != 0;
  return value;
}
inline void SatParameters::clear_lns_initial_difficulty() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.lns_initial_difficulty_ = 0.5;
  _impl_._has_bits_[8] &= ~0x00000004u;
}
inline double SatParameters::lns_initial_difficulty() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.lns_initial_difficulty)
  return _internal_lns_initial_difficulty();
}
inline void SatParameters::set_lns_initial_difficulty(double value) {
  _internal_set_lns_initial_difficulty(value);
  _impl_._has_bits_[8] |= 0x00000004u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.lns_initial_difficulty)
}
inline double SatParameters::_internal_lns_initial_difficulty() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.lns_initial_difficulty_;
}
inline void SatParameters::_internal_set_lns_initial_difficulty(double value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.lns_initial_difficulty_ = value;
}

// optional double lns_initial_deterministic_limit = 308 [default = 0.1];
inline bool SatParameters::has_lns_initial_deterministic_limit() const {
  bool value = (_impl_._has_bits_[8] & 0x00000008u) != 0;
  return value;
}
inline void SatParameters::clear_lns_initial_deterministic_limit() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.lns_initial_deterministic_limit_ = 0.1;
  _impl_._has_bits_[8] &= ~0x00000008u;
}
inline double SatParameters::lns_initial_deterministic_limit() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.lns_initial_deterministic_limit)
  return _internal_lns_initial_deterministic_limit();
}
inline void SatParameters::set_lns_initial_deterministic_limit(double value) {
  _internal_set_lns_initial_deterministic_limit(value);
  _impl_._has_bits_[8] |= 0x00000008u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.lns_initial_deterministic_limit)
}
inline double SatParameters::_internal_lns_initial_deterministic_limit() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.lns_initial_deterministic_limit_;
}
inline void SatParameters::_internal_set_lns_initial_deterministic_limit(double value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.lns_initial_deterministic_limit_ = value;
}
...
// optional int32 lb_relax_num_workers_threshold = 296 [default = 16];
inline bool SatParameters::has_lb_relax_num_workers_threshold() const {
  bool value = (_impl_._has_bits_[7] & 0x80000000u) != 0;
  return value;
}
inline void SatParameters::clear_lb_relax_num_workers_threshold() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.lb_relax_num_workers_threshold_ = 16;
  _impl_._has_bits_[7] &= ~0x80000000u;
}
inline ::int32_t SatParameters::lb_relax_num_workers_threshold() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.lb_relax_num_workers_threshold)
  return _internal_lb_relax_num_workers_threshold();
}
inline void SatParameters::set_lb_relax_num_workers_threshold(::int32_t value) {
  _internal_set_lb_relax_num_workers_threshold(value);
  _impl_._has_bits_[7] |= 0x80000000u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.lb_relax_num_workers_threshold)
}
inline ::int32_t SatParameters::_internal_lb_relax_num_workers_threshold() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.lb_relax_num_workers_threshold_;
}
inline void SatParameters::_internal_set_lb_relax_num_workers_threshold(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.lb_relax_num_workers_threshold_ = value;
}
...
// optional bool use_symmetry_in_lp = 301 [default = false];
inline bool SatParameters::has_use_symmetry_in_lp() const {
  bool value = (_impl_._has_bits_[2] & 0x00002000u) != 0;
  return value;
}
inline void SatParameters::clear_use_symmetry_in_lp() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_symmetry_in_lp_ = false;
  _impl_._has_bits_[2] &= ~0x00002000u;
}
inline bool SatParameters::use_symmetry_in_lp() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.use_symmetry_in_lp)
  return _internal_use_symmetry_in_lp();
}
inline void SatParameters::set_use_symmetry_in_lp(bool value) {
  _internal_set_use_symmetry_in_lp(value);
  _impl_._has_bits_[2] |= 0x00002000u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.use_symmetry_in_lp)
}
inline bool SatParameters::_internal_use_symmetry_in_lp() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.use_symmetry_in_lp_;
}
inline void SatParameters::_internal_set_use_symmetry_in_lp(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_symmetry_in_lp_ = value;
}

// optional bool keep_symmetry_in_presolve = 303 [default = false];
inline bool SatParameters::has_keep_symmetry_in_presolve() const {
  bool value = (_impl_._has_bits_[2] & 0x00004000u) != 0;
  return value;
}
inline void SatParameters::clear_keep_symmetry_in_presolve() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.keep_symmetry_in_presolve_ = false;
  _impl_._has_bits_[2] &= ~0x00004000u;
}
inline bool SatParameters::keep_symmetry_in_presolve() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.keep_symmetry_in_presolve)
  return _internal_keep_symmetry_in_presolve();
}
inline void SatParameters::set_keep_symmetry_in_presolve(bool value) {
  _internal_set_keep_symmetry_in_presolve(value);
  _impl_._has_bits_[2] |= 0x00004000u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.keep_symmetry_in_presolve)
}
inline bool SatParameters::_internal_keep_symmetry_in_presolve() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.keep_symmetry_in_presolve_;
}
inline void SatParameters::_internal_set_keep_symmetry_in_presolve(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.keep_symmetry_in_presolve_ = value;
}

// optional double symmetry_detection_deterministic_time_limit = 302 [default = 1];
inline bool SatParameters::has_symmetry_detection_deterministic_time_limit() const {
  bool value = (_impl_._has_bits_[8] & 0x00000002u) != 0;
  return value;
}
inline void SatParameters::clear_symmetry_detection_deterministic_time_limit() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.symmetry_detection_deterministic_time_limit_ = 1;
  _impl_._has_bits_[8] &= ~0x00000002u;
}
inline double SatParameters::symmetry_detection_deterministic_time_limit() const {
  // @@protoc_insertion_point(field_get:operations_research.sat.SatParameters.symmetry_detection_deterministic_time_limit)
  return _internal_symmetry_detection_deterministic_time_limit();
}
inline void SatParameters::set_symmetry_detection_deterministic_time_limit(double value) {
  _internal_set_symmetry_detection_deterministic_time_limit(value);
  _impl_._has_bits_[8] |= 0x00000002u;
  // @@protoc_insertion_point(field_set:operations_research.sat.SatParameters.symmetry_detection_deterministic_time_limit)
}
inline double SatParameters::_internal_symmetry_detection_deterministic_time_limit() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.symmetry_detection_deterministic_time_limit_;
}
inline void SatParameters::_internal_set_symmetry_detection_deterministic_time_limit(double value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.symmetry_detection_deterministic_time_limit_ = value;
}
