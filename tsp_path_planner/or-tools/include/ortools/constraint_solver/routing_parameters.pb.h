...
#ifndef ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto_2epb_2eh
#define ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto_2epb_2eh
...
struct OR_PROTO_DLL TableStruct_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto {
...
OR_PROTO_DLL extern RoutingModelParametersDefaultTypeInternal _RoutingModelParameters_default_instance_;
class RoutingSearchParameters;
struct RoutingSearchParametersDefaultTypeInternal;
OR_PROTO_DLL extern RoutingSearchParametersDefaultTypeInternal _RoutingSearchParameters_default_instance_;
...
OR_PROTO_DLL extern RoutingSearchParameters_ImprovementSearchLimitParametersDefaultTypeInternal _RoutingSearchParameters_ImprovementSearchLimitParameters_default_instance_;
...
OR_PROTO_DLL extern RoutingSearchParameters_LocalSearchNeighborhoodOperatorsDefaultTypeInternal _RoutingSearchParameters_LocalSearchNeighborhoodOperators_default_instance_;
}  // namespace operations_research
namespace google {
namespace protobuf {
}  // namespace protobuf
...
OR_PROTO_DLL bool RoutingSearchParameters_PairInsertionStrategy_IsValid(int value);
OR_PROTO_DLL extern const uint32_t RoutingSearchParameters_PairInsertionStrategy_internal_data_[];
...
enum RoutingSearchParameters_InsertionSortingProperty : int {
  RoutingSearchParameters_InsertionSortingProperty_SORTING_PROPERTY_UNSPECIFIED = 0,
  RoutingSearchParameters_InsertionSortingProperty_SORTING_PROPERTY_ALLOWED_VEHICLES = 1,
  RoutingSearchParameters_InsertionSortingProperty_SORTING_PROPERTY_PENALTY = 2,
  RoutingSearchParameters_InsertionSortingProperty_SORTING_PROPERTY_PENALTY_OVER_ALLOWED_VEHICLES_RATIO = 3,
  RoutingSearchParameters_InsertionSortingProperty_SORTING_PROPERTY_HIGHEST_AVG_ARC_COST_TO_VEHICLE_START_ENDS = 4,
  RoutingSearchParameters_InsertionSortingProperty_SORTING_PROPERTY_LOWEST_AVG_ARC_COST_TO_VEHICLE_START_ENDS = 5,
  RoutingSearchParameters_InsertionSortingProperty_SORTING_PROPERTY_LOWEST_MIN_ARC_COST_TO_VEHICLE_START_ENDS = 6,
  RoutingSearchParameters_InsertionSortingProperty_SORTING_PROPERTY_HIGHEST_DIMENSION_USAGE = 7,
...
OR_PROTO_DLL bool RoutingSearchParameters_InsertionSortingProperty_IsValid(int value);
OR_PROTO_DLL extern const uint32_t RoutingSearchParameters_InsertionSortingProperty_internal_data_[];
constexpr RoutingSearchParameters_InsertionSortingProperty RoutingSearchParameters_InsertionSortingProperty_InsertionSortingProperty_MIN = static_cast<RoutingSearchParameters_InsertionSortingProperty>(0);
constexpr RoutingSearchParameters_InsertionSortingProperty RoutingSearchParameters_InsertionSortingProperty_InsertionSortingProperty_MAX = static_cast<RoutingSearchParameters_InsertionSortingProperty>(7);
constexpr int RoutingSearchParameters_InsertionSortingProperty_InsertionSortingProperty_ARRAYSIZE = 7 + 1;
OR_PROTO_DLL const ::google::protobuf::EnumDescriptor*
...
const std::string& RoutingSearchParameters_InsertionSortingProperty_Name(T value) {
  static_assert(std::is_same<T, RoutingSearchParameters_InsertionSortingProperty>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to InsertionSortingProperty_Name().");
  return RoutingSearchParameters_InsertionSortingProperty_Name(static_cast<RoutingSearchParameters_InsertionSortingProperty>(value));
}
template <>
inline const std::string& RoutingSearchParameters_InsertionSortingProperty_Name(RoutingSearchParameters_InsertionSortingProperty value) {
  return ::google::protobuf::internal::NameOfDenseEnum<RoutingSearchParameters_InsertionSortingProperty_descriptor,
                                                 0, 7>(
      static_cast<int>(value));
}
inline bool RoutingSearchParameters_InsertionSortingProperty_Parse(absl::string_view name, RoutingSearchParameters_InsertionSortingProperty* value) {
  return ::google::protobuf::internal::ParseNamedEnum<RoutingSearchParameters_InsertionSortingProperty>(
      RoutingSearchParameters_InsertionSortingProperty_descriptor(), name, value);
}
...
OR_PROTO_DLL bool RoutingSearchParameters_SchedulingSolver_IsValid(int value);
OR_PROTO_DLL extern const uint32_t RoutingSearchParameters_SchedulingSolver_internal_data_[];
...
class OR_PROTO_DLL RoutingSearchParameters_LocalSearchNeighborhoodOperators final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators) */ {
 public:
  ...
  void operator delete(RoutingSearchParameters_LocalSearchNeighborhoodOperators* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(RoutingSearchParameters_LocalSearchNeighborhoodOperators));
  }
#endif
  ...
  RoutingSearchParameters_LocalSearchNeighborhoodOperators* New(::google::protobuf::Arena* arena = nullptr) const {
 ...
 public:
  ...
  enum : int {
    ...
    kUseSwapActiveChainFieldNumber = 35,
    kUseShortestPathTwoOptFieldNumber = 36,
    kUseExchangeAndMakeActiveFieldNumber = 37,
    kUseExchangePathStartEndsAndMakeActiveFieldNumber = 38,
  };
  ...
  private:
  ::operations_research::OptionalBoolean _internal_use_swap_active_chain() const;
  void _internal_set_use_swap_active_chain(::operations_research::OptionalBoolean value);
  ...
  private:
  ::operations_research::OptionalBoolean _internal_use_shortest_path_two_opt() const;
  void _internal_set_use_shortest_path_two_opt(::operations_research::OptionalBoolean value);
  ...
  private:
  ::operations_research::OptionalBoolean _internal_use_exchange_and_make_active() const;
  void _internal_set_use_exchange_and_make_active(::operations_research::OptionalBoolean value);
  ...
  private:
  ::operations_research::OptionalBoolean _internal_use_exchange_path_start_ends_and_make_active() const;
  void _internal_set_use_exchange_path_start_ends_and_make_active(::operations_research::OptionalBoolean value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                          ...
                          const RoutingSearchParameters_LocalSearchNeighborhoodOperators& from_msg);
    int use_relocate_;
    ...
    int use_swap_active_chain_;
    int use_shortest_path_two_opt_;
    int use_exchange_and_make_active_;
    int use_exchange_path_start_ends_and_make_active_;
...
class OR_PROTO_DLL RoutingSearchParameters_ImprovementSearchLimitParameters final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters.ImprovementSearchLimitParameters) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(RoutingSearchParameters_ImprovementSearchLimitParameters* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(RoutingSearchParameters_ImprovementSearchLimitParameters));
  }
#endif
  ...
  RoutingSearchParameters_ImprovementSearchLimitParameters* New(::google::protobuf::Arena* arena = nullptr) const {
 ...
 private:
  ...
  struct Impl_ {
    ...
    inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                          ::google::protobuf::Arena* arena, const Impl_& from,
                          const RoutingSearchParameters_ImprovementSearchLimitParameters& from_msg);
...
class OR_PROTO_DLL RoutingModelParameters final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.RoutingModelParameters) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(RoutingModelParameters* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(RoutingModelParameters));
  }
#endif
  ...
  RoutingModelParameters* New(::google::protobuf::Arena* arena = nullptr) const {
 ...
 private:
  ...
  struct Impl_ {
    ...
    inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                          ::google::protobuf::Arena* arena, const Impl_& from,
                          const RoutingModelParameters& from_msg);
...
class OR_PROTO_DLL RoutingSearchParameters final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(RoutingSearchParameters* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(RoutingSearchParameters));
  }
#endif
  ...
  RoutingSearchParameters* New(::google::protobuf::Arena* arena = nullptr) const {
 ...
 public:
  ...
  static inline bool InsertionSortingProperty_IsValid(int value) {
    return RoutingSearchParameters_InsertionSortingProperty_IsValid(value);
  }
  ...
  static inline const ::google::protobuf::EnumDescriptor* InsertionSortingProperty_descriptor() {
    return RoutingSearchParameters_InsertionSortingProperty_descriptor();
  }
  template <typename T>
  static inline const std::string& InsertionSortingProperty_Name(T value) {
    return RoutingSearchParameters_InsertionSortingProperty_Name(value);
  }
  static inline bool InsertionSortingProperty_Parse(absl::string_view name, InsertionSortingProperty* value) {
    return RoutingSearchParameters_InsertionSortingProperty_Parse(name, value);
  }
  ...
  // accessors -------------------------------------------------------
  enum : int {
    kLocalSearchMetaheuristicsFieldNumber = 63,
    kLocalCheapestInsertionSortingPropertiesFieldNumber = 67,
    ...
    kUseGuidedLocalSearchPenaltiesInLocalSearchOperatorsFieldNumber = 62,
    ...
    kGuidedLocalSearchPenalizeWithVehicleClassesFieldNumber = 61,
    ...
    kNumMaxLocalOptimaBeforeMetaheuristicSwitchFieldNumber = 64,
    kMaxSwapActiveChainSizeFieldNumber = 66,
  };
  ...
  private:
  int _internal_local_search_metaheuristics_size() const;
  ...
  ::google::protobuf::RepeatedField<int>* mutable_local_search_metaheuristics();

  private:
  const ::google::protobuf::RepeatedField<int>& _internal_local_search_metaheuristics() const;
  ::google::protobuf::RepeatedField<int>* _internal_mutable_local_search_metaheuristics();
  ...
  private:
  int _internal_local_cheapest_insertion_sorting_properties_size() const;
  ...
  ::google::protobuf::RepeatedField<int>* mutable_local_cheapest_insertion_sorting_properties();

  private:
  const ::google::protobuf::RepeatedField<int>& _internal_local_cheapest_insertion_sorting_properties() const;
  ::google::protobuf::RepeatedField<int>* _internal_mutable_local_cheapest_insertion_sorting_properties();
  ...
  private:
  bool _internal_use_guided_local_search_penalties_in_local_search_operators() const;
  void _internal_set_use_guided_local_search_penalties_in_local_search_operators(bool value);
  ...
  private:
  bool _internal_guided_local_search_penalize_with_vehicle_classes() const;
  void _internal_set_guided_local_search_penalize_with_vehicle_classes(bool value);
  ...
  private:
  ::int32_t _internal_num_max_local_optima_before_metaheuristic_switch() const;
  void _internal_set_num_max_local_optima_before_metaheuristic_switch(::int32_t value);
  ...
  private:
  ::int32_t _internal_max_swap_active_chain_size() const;
  void _internal_set_max_swap_active_chain_size(::int32_t value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                          ::google::protobuf::Arena* arena, const Impl_& from,
                          const RoutingSearchParameters& from_msg);
    ::google::protobuf::internal::HasBits<1> _has_bits_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    ::google::protobuf::RepeatedField<int> local_search_metaheuristics_;
    ::google::protobuf::internal::CachedSize _local_search_metaheuristics_cached_byte_size_;
    ::google::protobuf::RepeatedField<int> local_cheapest_insertion_sorting_properties_;
    ::google::protobuf::internal::CachedSize _local_cheapest_insertion_sorting_properties_cached_byte_size_;
    ...
    bool use_guided_local_search_penalties_in_local_search_operators_;
    ...
    bool guided_local_search_penalize_with_vehicle_classes_;
    ...
    ::int32_t num_max_local_optima_before_metaheuristic_switch_;
    ::int32_t max_swap_active_chain_size_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto;
...
// .operations_research.OptionalBoolean use_exchange_and_make_active = 37;
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::clear_use_exchange_and_make_active() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_exchange_and_make_active_ = 0;
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::use_exchange_and_make_active() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_exchange_and_make_active)
  return _internal_use_exchange_and_make_active();
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::set_use_exchange_and_make_active(::operations_research::OptionalBoolean value) {
  _internal_set_use_exchange_and_make_active(value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_exchange_and_make_active)
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_use_exchange_and_make_active() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::operations_research::OptionalBoolean>(_impl_.use_exchange_and_make_active_);
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_set_use_exchange_and_make_active(::operations_research::OptionalBoolean value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_exchange_and_make_active_ = value;
}

// .operations_research.OptionalBoolean use_exchange_path_start_ends_and_make_active = 38;
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::clear_use_exchange_path_start_ends_and_make_active() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_exchange_path_start_ends_and_make_active_ = 0;
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::use_exchange_path_start_ends_and_make_active() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_exchange_path_start_ends_and_make_active)
  return _internal_use_exchange_path_start_ends_and_make_active();
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::set_use_exchange_path_start_ends_and_make_active(::operations_research::OptionalBoolean value) {
  _internal_set_use_exchange_path_start_ends_and_make_active(value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_exchange_path_start_ends_and_make_active)
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_use_exchange_path_start_ends_and_make_active() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::operations_research::OptionalBoolean>(_impl_.use_exchange_path_start_ends_and_make_active_);
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_set_use_exchange_path_start_ends_and_make_active(::operations_research::OptionalBoolean value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_exchange_path_start_ends_and_make_active_ = value;
}
...
// .operations_research.OptionalBoolean use_swap_active_chain = 35;
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::clear_use_swap_active_chain() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_swap_active_chain_ = 0;
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::use_swap_active_chain() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_swap_active_chain)
  return _internal_use_swap_active_chain();
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::set_use_swap_active_chain(::operations_research::OptionalBoolean value) {
  _internal_set_use_swap_active_chain(value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_swap_active_chain)
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_use_swap_active_chain() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::operations_research::OptionalBoolean>(_impl_.use_swap_active_chain_);
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_set_use_swap_active_chain(::operations_research::OptionalBoolean value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_swap_active_chain_ = value;
}
...
// .operations_research.OptionalBoolean use_shortest_path_two_opt = 36;
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::clear_use_shortest_path_two_opt() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_shortest_path_two_opt_ = 0;
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::use_shortest_path_two_opt() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_shortest_path_two_opt)
  return _internal_use_shortest_path_two_opt();
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::set_use_shortest_path_two_opt(::operations_research::OptionalBoolean value) {
  _internal_set_use_shortest_path_two_opt(value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators.use_shortest_path_two_opt)
}
inline ::operations_research::OptionalBoolean RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_use_shortest_path_two_opt() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::operations_research::OptionalBoolean>(_impl_.use_shortest_path_two_opt_);
}
inline void RoutingSearchParameters_LocalSearchNeighborhoodOperators::_internal_set_use_shortest_path_two_opt(::operations_research::OptionalBoolean value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_shortest_path_two_opt_ = value;
}
...
// repeated .operations_research.RoutingSearchParameters.InsertionSortingProperty local_cheapest_insertion_sorting_properties = 67;
inline int RoutingSearchParameters::_internal_local_cheapest_insertion_sorting_properties_size() const {
  return _internal_local_cheapest_insertion_sorting_properties().size();
}
inline int RoutingSearchParameters::local_cheapest_insertion_sorting_properties_size() const {
  return _internal_local_cheapest_insertion_sorting_properties_size();
}
inline void RoutingSearchParameters::clear_local_cheapest_insertion_sorting_properties() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.local_cheapest_insertion_sorting_properties_.Clear();
}
inline ::operations_research::RoutingSearchParameters_InsertionSortingProperty RoutingSearchParameters::local_cheapest_insertion_sorting_properties(int index) const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.local_cheapest_insertion_sorting_properties)
  return static_cast<::operations_research::RoutingSearchParameters_InsertionSortingProperty>(_internal_local_cheapest_insertion_sorting_properties().Get(index));
}
inline void RoutingSearchParameters::set_local_cheapest_insertion_sorting_properties(int index, ::operations_research::RoutingSearchParameters_InsertionSortingProperty value) {
  _internal_mutable_local_cheapest_insertion_sorting_properties()->Set(index, value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.local_cheapest_insertion_sorting_properties)
}
inline void RoutingSearchParameters::add_local_cheapest_insertion_sorting_properties(::operations_research::RoutingSearchParameters_InsertionSortingProperty value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_local_cheapest_insertion_sorting_properties()->Add(value);
  // @@protoc_insertion_point(field_add:operations_research.RoutingSearchParameters.local_cheapest_insertion_sorting_properties)
}
inline const ::google::protobuf::RepeatedField<int>& RoutingSearchParameters::local_cheapest_insertion_sorting_properties() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:operations_research.RoutingSearchParameters.local_cheapest_insertion_sorting_properties)
  return _internal_local_cheapest_insertion_sorting_properties();
}
inline ::google::protobuf::RepeatedField<int>* RoutingSearchParameters::mutable_local_cheapest_insertion_sorting_properties()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ...
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_local_cheapest_insertion_sorting_properties();
}
inline const ::google::protobuf::RepeatedField<int>& RoutingSearchParameters::_internal_local_cheapest_insertion_sorting_properties()
    const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.local_cheapest_insertion_sorting_properties_;
}
inline ::google::protobuf::RepeatedField<int>* RoutingSearchParameters::_internal_mutable_local_cheapest_insertion_sorting_properties() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.local_cheapest_insertion_sorting_properties_;
}
...
// int32 max_swap_active_chain_size = 66;
inline void RoutingSearchParameters::clear_max_swap_active_chain_size() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.max_swap_active_chain_size_ = 0;
}
inline ::int32_t RoutingSearchParameters::max_swap_active_chain_size() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.max_swap_active_chain_size)
  return _internal_max_swap_active_chain_size();
}
inline void RoutingSearchParameters::set_max_swap_active_chain_size(::int32_t value) {
  _internal_set_max_swap_active_chain_size(value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.max_swap_active_chain_size)
}
inline ::int32_t RoutingSearchParameters::_internal_max_swap_active_chain_size() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.max_swap_active_chain_size_;
}
inline void RoutingSearchParameters::_internal_set_max_swap_active_chain_size(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.max_swap_active_chain_size_ = value;
}
...
// repeated .operations_research.LocalSearchMetaheuristic.Value local_search_metaheuristics = 63;
inline int RoutingSearchParameters::_internal_local_search_metaheuristics_size() const {
  return _internal_local_search_metaheuristics().size();
}
inline int RoutingSearchParameters::local_search_metaheuristics_size() const {
  return _internal_local_search_metaheuristics_size();
}
inline void RoutingSearchParameters::clear_local_search_metaheuristics() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.local_search_metaheuristics_.Clear();
}
inline ::operations_research::LocalSearchMetaheuristic_Value RoutingSearchParameters::local_search_metaheuristics(int index) const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.local_search_metaheuristics)
  return static_cast<::operations_research::LocalSearchMetaheuristic_Value>(_internal_local_search_metaheuristics().Get(index));
}
inline void RoutingSearchParameters::set_local_search_metaheuristics(int index, ::operations_research::LocalSearchMetaheuristic_Value value) {
  _internal_mutable_local_search_metaheuristics()->Set(index, value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.local_search_metaheuristics)
}
inline void RoutingSearchParameters::add_local_search_metaheuristics(::operations_research::LocalSearchMetaheuristic_Value value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_local_search_metaheuristics()->Add(value);
  // @@protoc_insertion_point(field_add:operations_research.RoutingSearchParameters.local_search_metaheuristics)
}
inline const ::google::protobuf::RepeatedField<int>& RoutingSearchParameters::local_search_metaheuristics() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:operations_research.RoutingSearchParameters.local_search_metaheuristics)
  return _internal_local_search_metaheuristics();
}
inline ::google::protobuf::RepeatedField<int>* RoutingSearchParameters::mutable_local_search_metaheuristics()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:operations_research.RoutingSearchParameters.local_search_metaheuristics)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_local_search_metaheuristics();
}
inline const ::google::protobuf::RepeatedField<int>& RoutingSearchParameters::_internal_local_search_metaheuristics()
    const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.local_search_metaheuristics_;
}
inline ::google::protobuf::RepeatedField<int>* RoutingSearchParameters::_internal_mutable_local_search_metaheuristics() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.local_search_metaheuristics_;
}

// int32 num_max_local_optima_before_metaheuristic_switch = 64;
inline void RoutingSearchParameters::clear_num_max_local_optima_before_metaheuristic_switch() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.num_max_local_optima_before_metaheuristic_switch_ = 0;
}
inline ::int32_t RoutingSearchParameters::num_max_local_optima_before_metaheuristic_switch() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.num_max_local_optima_before_metaheuristic_switch)
  return _internal_num_max_local_optima_before_metaheuristic_switch();
}
inline void RoutingSearchParameters::set_num_max_local_optima_before_metaheuristic_switch(::int32_t value) {
  _internal_set_num_max_local_optima_before_metaheuristic_switch(value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.num_max_local_optima_before_metaheuristic_switch)
}
inline ::int32_t RoutingSearchParameters::_internal_num_max_local_optima_before_metaheuristic_switch() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.num_max_local_optima_before_metaheuristic_switch_;
}
inline void RoutingSearchParameters::_internal_set_num_max_local_optima_before_metaheuristic_switch(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.num_max_local_optima_before_metaheuristic_switch_ = value;
}
...
// bool guided_local_search_penalize_with_vehicle_classes = 61;
inline void RoutingSearchParameters::clear_guided_local_search_penalize_with_vehicle_classes() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.guided_local_search_penalize_with_vehicle_classes_ = false;
}
inline bool RoutingSearchParameters::guided_local_search_penalize_with_vehicle_classes() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.guided_local_search_penalize_with_vehicle_classes)
  return _internal_guided_local_search_penalize_with_vehicle_classes();
}
inline void RoutingSearchParameters::set_guided_local_search_penalize_with_vehicle_classes(bool value) {
  _internal_set_guided_local_search_penalize_with_vehicle_classes(value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.guided_local_search_penalize_with_vehicle_classes)
}
inline bool RoutingSearchParameters::_internal_guided_local_search_penalize_with_vehicle_classes() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.guided_local_search_penalize_with_vehicle_classes_;
}
inline void RoutingSearchParameters::_internal_set_guided_local_search_penalize_with_vehicle_classes(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.guided_local_search_penalize_with_vehicle_classes_ = value;
}

// bool use_guided_local_search_penalties_in_local_search_operators = 62;
inline void RoutingSearchParameters::clear_use_guided_local_search_penalties_in_local_search_operators() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_guided_local_search_penalties_in_local_search_operators_ = false;
}
inline bool RoutingSearchParameters::use_guided_local_search_penalties_in_local_search_operators() const {
  // @@protoc_insertion_point(field_get:operations_research.RoutingSearchParameters.use_guided_local_search_penalties_in_local_search_operators)
  return _internal_use_guided_local_search_penalties_in_local_search_operators();
}
inline void RoutingSearchParameters::set_use_guided_local_search_penalties_in_local_search_operators(bool value) {
  _internal_set_use_guided_local_search_penalties_in_local_search_operators(value);
  // @@protoc_insertion_point(field_set:operations_research.RoutingSearchParameters.use_guided_local_search_penalties_in_local_search_operators)
}
inline bool RoutingSearchParameters::_internal_use_guided_local_search_penalties_in_local_search_operators() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.use_guided_local_search_penalties_in_local_search_operators_;
}
inline void RoutingSearchParameters::_internal_set_use_guided_local_search_penalties_in_local_search_operators(bool value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.use_guided_local_search_penalties_in_local_search_operators_ = value;
}
...
inline void RoutingSearchParameters::set_allocated_log_tag(std::string* value) {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.log_tag_.IsDefault()) {
...
template <>
struct is_proto_enum<::operations_research::RoutingSearchParameters_InsertionSortingProperty> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::operations_research::RoutingSearchParameters_InsertionSortingProperty>() {
  return ::operations_research::RoutingSearchParameters_InsertionSortingProperty_descriptor();
}
template <>
...
#endif  // ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto_2epb_2eh
