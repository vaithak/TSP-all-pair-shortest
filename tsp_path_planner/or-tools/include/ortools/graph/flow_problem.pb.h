...
#ifndef ortools_2fgraph_2fflow_5fproblem_2eproto_2epb_2eh
#define ortools_2fgraph_2fflow_5fproblem_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_ortools_2fgraph_2fflow_5fproblem_2eproto OR_PROTO_DLL
...
struct OR_PROTO_DLL TableStruct_ortools_2fgraph_2fflow_5fproblem_2eproto {
...
OR_PROTO_DLL extern FlowArcProtoDefaultTypeInternal _FlowArcProto_default_instance_;
class FlowModelProto;
struct FlowModelProtoDefaultTypeInternal;
OR_PROTO_DLL extern FlowModelProtoDefaultTypeInternal _FlowModelProto_default_instance_;
class FlowNodeProto;
struct FlowNodeProtoDefaultTypeInternal;
OR_PROTO_DLL extern FlowNodeProtoDefaultTypeInternal _FlowNodeProto_default_instance_;
}  // namespace operations_research
namespace google {
namespace protobuf {
}  // namespace protobuf
...
OR_PROTO_DLL bool FlowModelProto_ProblemType_IsValid(int value);
OR_PROTO_DLL extern const uint32_t FlowModelProto_ProblemType_internal_data_[];
...
class OR_PROTO_DLL FlowNodeProto final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.FlowNodeProto) */ {
 public:
  ...
  void operator delete(FlowNodeProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(FlowNodeProto));
  }
#endif
  ...
  FlowNodeProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
class OR_PROTO_DLL FlowArcProto final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.FlowArcProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(FlowArcProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(FlowArcProto));
  }
#endif
  ...
  FlowArcProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
class OR_PROTO_DLL FlowModelProto final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:operations_research.FlowModelProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(FlowModelProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(FlowModelProto));
  }
#endif
  ...
  FlowModelProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // ortools_2fgraph_2fflow_5fproblem_2eproto_2epb_2eh
