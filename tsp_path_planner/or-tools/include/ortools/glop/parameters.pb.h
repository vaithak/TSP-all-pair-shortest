...
OR_PROTO_DLL bool GlopParameters_ScalingAlgorithm_IsValid(int value);
...
OR_PROTO_DLL bool GlopParameters_SolverBehavior_IsValid(int value);
...
OR_PROTO_DLL bool GlopParameters_PricingRule_IsValid(int value);
...
OR_PROTO_DLL bool GlopParameters_InitialBasisHeuristic_IsValid(int value);
...
OR_PROTO_DLL bool GlopParameters_CostScalingAlgorithm_IsValid(int value);
...
/* @@protoc_insertion_point(class_definition:operations_research.glop.GlopParameters) */ {
 public:
  ...
  void operator delete(GlopParameters* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  GlopParameters* New(::google::protobuf::Arena* arena = nullptr) const {
