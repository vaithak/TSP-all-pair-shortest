...
/* @@protoc_insertion_point(class_definition:operations_research.math_opt.OsqpSettingsProto) */ {
 public:
  ...
  void operator delete(OsqpSettingsProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  OsqpSettingsProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:operations_research.math_opt.OsqpOutput) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(OsqpOutput* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  OsqpOutput* New(::google::protobuf::Arena* arena = nullptr) const {
