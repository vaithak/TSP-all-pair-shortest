...
/* @@protoc_insertion_point(class_definition:operations_research.math_opt.StatusProto) */ {
 public:
  ...
  void operator delete(StatusProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  StatusProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:operations_research.math_opt.SolverResourcesProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(SolverResourcesProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SolverResourcesProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:operations_research.math_opt.SolveResponse) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(SolveResponse* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SolveResponse* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:operations_research.math_opt.SolveRequest) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(SolveRequest* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SolveRequest* New(::google::protobuf::Arena* arena = nullptr) const {
...
inline std::string* SolveResponse::add_messages() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
