...
OR_PROTO_DLL bool SolverTypeProto_IsValid(int value);
...
constexpr SolverTypeProto SolverTypeProto_MAX = static_cast<SolverTypeProto>(12);
constexpr int SolverTypeProto_ARRAYSIZE = 12 + 1;
...
OR_PROTO_DLL bool LPAlgorithmProto_IsValid(int value);
...
OR_PROTO_DLL bool EmphasisProto_IsValid(int value);
...
/* @@protoc_insertion_point(class_definition:operations_research.math_opt.StrictnessProto) */ {
 public:
  ...
  void operator delete(StrictnessProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  StrictnessProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:operations_research.math_opt.SolverInitializerProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(SolverInitializerProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SolverInitializerProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:operations_research.math_opt.SolveParametersProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(SolveParametersProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SolveParametersProto* New(::google::protobuf::Arena* arena = nullptr) const {
