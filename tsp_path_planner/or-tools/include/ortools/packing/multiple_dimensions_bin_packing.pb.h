...
/* @@protoc_insertion_point(class_definition:operations_research.packing.MultipleDimensionsBinPackingShape) */ {
 public:
  ...
  void operator delete(MultipleDimensionsBinPackingShape* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MultipleDimensionsBinPackingShape* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:operations_research.packing.MultipleDimensionsBinPackingItem) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(MultipleDimensionsBinPackingItem* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MultipleDimensionsBinPackingItem* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:operations_research.packing.MultipleDimensionsBinPackingProblem) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(MultipleDimensionsBinPackingProblem* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MultipleDimensionsBinPackingProblem* New(::google::protobuf::Arena* arena = nullptr) const {
